...
```bash
/iterate <task>                        # Full mode (requires Codex MCP)
/iterate --lite <task>                 # Lite mode (no Codex required)
/iterate --max-iterations 5 <task>     # Limit iterations
/iterate-status                        # Check progress
```

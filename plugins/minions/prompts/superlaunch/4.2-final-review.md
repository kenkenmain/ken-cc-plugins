...
- **Supplementary (parallel):**
  - `minions:code-quality-reviewer` — final code quality sweep
  - `minions:test-coverage-reviewer` — test coverage completeness
  - `minions:comment-reviewer` — comment accuracy and maintainability
...
1. Read all phase outputs: plan (1.2), tasks (2.1), test results (3.1), prior reviews

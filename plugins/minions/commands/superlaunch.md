...
description: Superlaunch — Claude-only 4-phase workflow with skill-documented orchestration and loop-back issue resolution
argument-hint: <task description>
---

# Minions Superlaunch

You are launching a Claude-only 4-phase development workflow with skill-documented orchestration and personality-driven agents.
...
```
Minions Superlaunch — 4-Phase Workflow
====================================

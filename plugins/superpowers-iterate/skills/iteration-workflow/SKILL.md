...
description: Use when orchestrating a complete 8-phase development iteration. Activated by /superpowers-iterate:iterate command or when user asks to follow the iteration workflow.
---

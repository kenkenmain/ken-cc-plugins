#!/usr/bin/env bash
# state.sh -- Shared library for reading/writing .agents/tmp/iterate/state.json
...
# Environment
# ---------------------------------------------------------------------------
STATE_DIR="${CLAUDE_PROJECT_DIR:-.}/.agents/tmp/iterate"
...
#   under .agents/tmp/iterate/phases/. Returns 0 if it exists, 1 otherwise.
#   Example: if phase_file_exists "3-plan-review.json"; then ...
# ---------------------------------------------------------------------------
phase_file_exists() {

...
Phase 3 (Plan Review):  tool=codex-high
...
Phase 8 (Final Review): tool=codex-high
Phase 9 (Codex Final):  tool=codex-xhigh [fixed]
...
- options (show current values in labels):
  ...
  - label: "Phase 2: Plan (model=inherit, parallel=true)"
    description: "Configure model and parallel agents"
  - label: "Phase 3: Plan Review (tool=codex-high)"
  ...
  - label: "Phase 7: Simplify (model=inherit)"
    description: "Configure model"
  - label: "Phase 8: Final Review (tool=codex-high)"
    description: "Configure review tool"

Note: Phase 6 (Test) is bash-only. Phase 9 (Codex Final) is fixed to `codex-xhigh`.
...
### For Phases 3, 8 (Codex CLI review phases)

Ask which tool: codex-high (recommended), codex-xhigh, or claude-review
...
- Phase 3: tool=claude-review (was: codex-high)

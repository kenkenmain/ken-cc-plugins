...
| `codex-explore-aggregator.md` | 0 (aggregator)    | Thin codex-high MCP wrapper for explore aggregation |
...
| `codex-plan-aggregator.md`  | 1.2 (aggregator)    | Thin codex-high MCP wrapper for plan aggregation |

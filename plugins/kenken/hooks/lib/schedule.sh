#!/usr/bin/env bash
# schedule.sh -- Phase advancement logic for the kenken workflow.
...
get_phase_output() {
  ...
  case "$phase" in
    ...
    3.1) echo "3.1-test-plan.md" ;;
    3.2) echo "3.2-tests-written.md" ;;
    3.3) echo "3.3-coverage.json" ;;
    3.4) echo "3.4-test-results.json" ;;
    3.5) echo "3.5-test-review.json" ;;
    4.1) echo "4.1-final-review.json" ;;
    4.2) echo "4.2-extensions.json" ;;
...
get_phase_input_files() {
  ...
  case "$phase" in
    1.1) echo "task description (from state.json)" ;;
    1.2) echo ".agents/tmp/kenken/phases/1.1-brainstorm.md" ;;
    1.3) echo ".agents/tmp/kenken/phases/1.2-plan.md" ;;
    2.1) echo ".agents/tmp/kenken/phases/1.2-plan.md" ;;
    2.2) echo ".agents/tmp/kenken/phases/2.1-tasks.json" ;;
    2.3) echo ".agents/tmp/kenken/phases/1.2-plan.md, git diff" ;;
    3.1) echo ".agents/tmp/kenken/phases/1.2-plan.md, .agents/tmp/kenken/phases/2.1-tasks.json" ;;
    3.2) echo ".agents/tmp/kenken/phases/3.1-test-plan.md" ;;
    3.3) echo ".agents/tmp/kenken/phases/3.2-tests-written.md" ;;
    3.4) echo "config test commands" ;;
    3.5) echo ".agents/tmp/kenken/phases/3.4-test-results.json, .agents/tmp/kenken/phases/3.3-coverage.json" ;;
    4.1) echo "all .agents/tmp/kenken/phases/*.json" ;;
    4.2) echo ".agents/tmp/kenken/phases/4.1-final-review.json" ;;
    4.3) echo ".agents/tmp/kenken/phases/4.2-extensions.json" ;;
    *)   echo "" ;;
  esac
}
...
get_phase_template() {
  ...
  case "$phase" in
    ...
    3.1) echo "3.1-test-plan.md" ;;
    3.2) echo "3.2-write-tests.md" ;;
    3.3) echo "3.3-coverage.md" ;;
    3.4) echo "3.4-run-tests.md" ;;
    3.5) echo "3.5-test-review.md" ;;
    4.1) echo "4.1-final-review.md" ;;
    4.2) echo "4.2-extensions.md" ;;
